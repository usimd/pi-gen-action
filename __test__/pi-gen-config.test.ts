...
describe('PiGenConfig', () => {
  ...
  it.each([
    ...
    [
      'tempRepo',
      'deb s3://trying-a-bucket-as-source-for-once',
      'temp-repo contains an invalid one-line-style format. See readme for details. Offending line: deb s3://trying-a-bucket-as-source-for-once'
    ]
  ])(
  ...
  ])('should allow tempRepo with line value %s', async (value: string) => {
    const piGenConfig = {
      ...DEFAULT_CONFIG,
      stageList: ['stage0', 'stage1', 'stage2'],
      tempRepo: value
